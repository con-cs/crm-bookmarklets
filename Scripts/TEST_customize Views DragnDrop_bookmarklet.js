if(console && console.log) console.log('https://rawgit.com/con-cs/crm-bookmarklets/master/Scripts/TEST_customize Views DragnDrop_bookmarklet.js'); //build:CreateOnlineOnlyBookmarklet
var Connectiv;
