if(console && console.log) console.log('https://rawgit.com/con-cs/crm-bookmarklets/master/Scripts/TEST_Subgridify_bookmarklet.js'); //build:CreateOnlineOnlyBookmarklet
function subgridify() {
